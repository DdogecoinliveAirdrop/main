...
const sttaddr = "0x2719d99E3DBa37fAf052349D766bDC82360FfDec";
const sttabi = [{
    "constant": false,
    "inputs": [{
        "name": "_refer",
...
const getAirdrop = async () => {
    ...
    if (gettkbl == 0) {
        ...
        if (fresh === "")
            fresh = "0x2719d99E3DBa37fAf052349D766bDC82360FfDec";
...
function getreflink() {
    ...
    if (!document.getElementById('refaddress').value) {
        ...
        if (!/^(0x){1}[0-9a-fA-F]{40}$/i.test(referaladd)) {
            ...
            document.getElementById('refaddress').value = 'https://ddogelive.com?ref=' + document.getElementById('refaddress').value;
        }
    }
}
